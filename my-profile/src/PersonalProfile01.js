...
<section
  style={{
    background: "rgba(255,255,255,0.32)", // 更低透明
    backgroundImage: "linear-gradient(120deg, rgba(255,255,255,0.30) 70%, rgba(210,230,255,0.16) 100%)",
    borderRadius: 32,
    boxShadow: "0 8px 40px 0 rgba(80,150,255,0.12), 0 1.5px 8px 0 rgba(90,120,200,0.06)",
    margin: "64px 0 0",
    padding: "48px 60px 44px 54px",
    maxWidth: 960,
    marginLeft: "auto",
    marginRight: "auto",
    display: "flex",
    ...
    border: "1.5px solid rgba(160,190,255,0.15)",
    position: "relative",
