...
<div
  style={{
    ...
    position: "relative",
    zIndex: 99,
	marginLeft: 360  // ⭐️整組 header 右移 120px
...
<div style={{
  ...
  {["Innovative", "Intelligence", "Integration", "Efficient", "Reliable"].map((word, idx) => (
    <span
      key={word}
      style={{
        display: "inline-block", // 保證 transform 有效
        transition: "transform 0.25s cubic-bezier(.7,.2,.4,1.1), color 0.23s, text-shadow 0.23s",
        fontSize: 23,
        fontWeight: 800,
        color: "#1976d2",
        cursor: "pointer",
